AFRAME.registerComponent("atoms", {
  ...
  createAtoms: async function (element) {
    ...
    var electron_numb = element.number_of_electron;
    ...
    for (var i=1; i<=electron_numb; i++) {
      ...
      orbit.setAttribute("rotation",{x:0,y:orb_ang,z:0})
      orb_ang+=45
      atom.appendChild(orbit)
      var elecAnimation=document.createElement("a-entity")
      elecAnimation.setAttribute("id",`electron-group-${elementName}`)
      elecAnimation.setAttribute("rotation",{x:0,y:0,z:electron_ang})
      electron_ang+=65
      elecAnimation.setAttribute("animation",{property:"rotation",to:`0 0 -360`,loop:"true",dur:3500,easing:"linear"})
      orbit.appendChild(elecAnimation)
      ...
      elecAnimation.appendChild(electron)
    }
  }
});
